...
bool Timeline_Statement::accept(Statement_Visitor& visitor) { return visitor.visit(*this); }
bool Timeline_Statement::accept(const Statement_Visitor& visitor) const  { return visitor.visit(*this); }
