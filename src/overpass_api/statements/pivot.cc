...
bool Pivot_Statement::accept(Statement_Visitor& visitor) { return visitor.visit(*this); }
bool Pivot_Statement::accept(const Statement_Visitor& visitor) const  { return visitor.visit(*this); }
