...
public:
  ...
  virtual void print_item(const Node_Skeleton& skel,
      ...
      const OSM_Element_Metadata_Skeleton< Node::Id_Type >* new_meta = nullptr) = 0;
  ...
  virtual void print_item(const Way_Skeleton& skel,
      ...
      const Opaque_Geometry* new_geometry = nullptr,
      const std::vector< std::pair< std::string, std::string > >* new_tags = nullptr,
      const OSM_Element_Metadata_Skeleton< Way::Id_Type >* new_meta = nullptr) = 0;
  ...
  virtual void print_item(const Relation_Skeleton& skel,
      ...
      const Opaque_Geometry* new_geometry = nullptr,
      const std::vector< std::pair< std::string, std::string > >* new_tags = nullptr,
      const OSM_Element_Metadata_Skeleton< Relation::Id_Type >* new_meta = nullptr) = 0;
