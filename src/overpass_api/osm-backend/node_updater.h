...
struct Node_Updater
{
  Node_Updater(Transaction& transaction, meta_modes meta, unsigned int parallel_processes = 1);

  Node_Updater(std::string db_dir, meta_modes meta, unsigned int parallel_processes = 1);
